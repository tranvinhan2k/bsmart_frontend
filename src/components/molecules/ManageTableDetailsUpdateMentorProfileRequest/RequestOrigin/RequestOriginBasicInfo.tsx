...
interface RequestOriginBasicInfoProps {
  rowId: number;
}
export default function RequestOriginBasicInfo({
  rowId,
}: RequestOriginBasicInfoProps) {
    ...
    ? [
        {
          ...
          value: updaterRequestDetails.userDtoOrigin.fullName ?? '',
        },
        {
          id: 0,
          label: Text.labelPhone,
          value: formatPhoneNumberVi(updaterRequestDetails.userDtoOrigin.phone),
        },
      ]
    : [];
    ...
    ? [
        {
          ...
          value:
            formatISODateStringToDisplayDate(
              updaterRequestDetails.userDtoOrigin.birthday
            ) ?? '',
        },
        {
          id: 1,
          ...
          value:
            genderData.find(
              (item) =>
                item.value === updaterRequestDetails.userDtoOrigin.gender
            )?.label ??
            genderData[0].value ??
            '',
        },
    ...
    ? [
        {
          ...
          value: updaterRequestDetails.userDtoOrigin.address,
        },
      ]
    : [];
    ...
    ? [
        {
          ...
          value: updaterRequestDetails.userDtoOrigin.website,
        },
        {
          id: 1,
          label: Text.labelLinkedIn,
          value: updaterRequestDetails.userDtoOrigin.linkedinLink,
        },
        {
          id: 2,
          label: Text.labelFacebook,
          value: updaterRequestDetails.userDtoOrigin.facebookLink,
        },
      ]
    : [];
