...
interface ManageTableNoPaginationProps extends DataGridProps {
  columns: GridColDef[];
  rows: any;
  // error?: any;
  // isLoading?: boolean;
...
export default function ManageTableNoPagination({
  columns,
  rows = [],
  // error = null,
  // onPageChange,
...
// ManageTableNoPagination.defaultProps = {
//   menuItemList: [],
//   searchFilterFormInputList: [],
//   getRowId: undefined,
//   error: null,
