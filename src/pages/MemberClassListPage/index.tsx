...
import { ClassMemberStatusList, ClassStatusList } from '~/constants';
...
export default function MemberClassListPage() {
  ...
  // parameters
  const chosenClassStatus = ClassMemberStatusList.find(
    ...
    <Stack>
      <Stack>
        ...
        <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
          ...
          >
            {ClassMemberStatusList.map((item, index) => (
              <Tab
