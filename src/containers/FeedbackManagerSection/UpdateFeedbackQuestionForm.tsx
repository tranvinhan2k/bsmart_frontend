...
interface UpdateFeedbackQuestionFormProps {
  row: any;
  onSubmit: (data: any) => void;
}

export default function UpdateFeedbackQuestionForm({
  row,
  onSubmit,
}: UpdateFeedbackQuestionFormProps) {
  ...
  const createFeedbackQuestionForm = useForm({
    defaultValues: { ...row, possibleAnswer: row.possibleAnswer || [] },
